...
class TestBolt11(ElectrumTestCase):
    ...
    def test_roundtrip(self):
        ...
        tests = [
            ...
            (LnAddr(date=timestamp, paymenthash=RHASH, net=constants.PandacoinTestnet, tags=[('f', 'mk2QpYatsKicvFVuTAQLBryyccRXMUaGHP'), ('h', longdescription)]),
    ...
    def test_min_final_cltv_expiry_decoding(self):
        ...
        lnaddr = lndecode("",
                          net=constants.PandacoinTestnet)
