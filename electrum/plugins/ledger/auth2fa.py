...
from btchip.btchip import PNDhipException
        ...
        def pin_changed(s):
            if len(s) < len(self.idxs):
                ...
                if not constants.net.TESTNET:
                    ...
                    addr_mainnet = bitcoin.script_to_address(bitcoin.address_to_script(addr), net=constants.PandacoinMainnet)
